...
export default function NavbarWithShop() {
    ...
    >
      <div className="max-w-7xl mx-auto px-8 md:px-14 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <a
            href="/shop"
            className="hidden md:block border border-white/20 px-6 py-2 text-xs tracking-[0.2em] uppercase text-white/80 hover:bg-white hover:text-black transition-all duration-300 rounded-full font-inter"
          >
            Shop Now
          </a>
